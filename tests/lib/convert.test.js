...
describe("Latitude to DD", () => {
  ...
  describe("Excess", () => {
    test("91°0′0″N", () => expect(() => latitudeToDD(91, 0, 0, "N")).toThrow());
    test("91°0′0″N", () => expect(() => latitudeToDD(91, 0, 0, "S")).toThrow());
    test("0°60′0″N", () => expect(() => latitudeToDD(0, 60, 0, "N")).toThrow());
    test("0°60′0″N", () => expect(() => latitudeToDD(0, 60, 0, "S")).toThrow());
    test("0°0′60″N", () => expect(() => latitudeToDD(0, 0, 60, "N")).toThrow());
    test("0°0′60″N", () => expect(() => latitudeToDD(0, 0, 60, "S")).toThrow());
    test("90°0′0.1″N", () =>
