...
import parseValues from "../../../src/geo-coord/parse-input/parse-values.js";
...
describe("Parse values", () => {
  describe("2 DD values", () => {
    ...
    describe("Invalid", () => {
      test("(-91, 180)", () =>
        expect(() => parseValues(sink(), -91, 180)).toThrow());
      test("(-90.1, 180)", () =>
        expect(() => parseValues(sink(), -90.1, 180)).toThrow());
      test("(-90, 181)", () =>
        expect(() => parseValues(sink(), -90, 181)).toThrow());
      test("(-90, 180.1)", () =>
        expect(() => parseValues(sink(), -90, 180.1)).toThrow());
    });
  });
  describe("4 DMS value parts", () => {
    ...
    describe("Invalid", () => {
      test("(91, S, 180, E)", () =>
        expect(() => parseValues(sink(), 91, "S", 180, "E")).toThrow());
      test("(90, S, 181, E)", () =>
        expect(() => parseValues(sink(), 90, "S", 181, "E")).toThrow());
    });
  });
  describe("5 DMS value parts", () => {
    ...
    describe("Invalid", () => {
      test("(90, 1, S, 180, E)", () =>
        expect(() => parseValues(sink(), 90, 1, "S", 180, "E")).toThrow());
      test("(90, S, 180, 1, E)", () =>
        expect(() => parseValues(sink(), 90, "S", 180, 1, "E")).toThrow());
    });
  });
  describe("6 DMS value parts", () => {
    ...
    describe("Invalid", () => {
      test("(90, 1, S, 180, 0, E)", () =>
        expect(() => parseValues(sink(), 90, 1, "S", 180, 0, "E")).toThrow());
      test("(90, 0, S, 180, 1, E)", () =>
        expect(() => parseValues(sink(), 90, 0, "S", 180, 1, "E")).toThrow());
    });
  });
  describe("7 DMS value parts", () => {
    ...
    describe("Invalid", () => {
      test("(90, 0, 1, S, 180, 0, E)", () =>
        expect(() =>
          parseValues(sink(), 90, 0, 1, "S", 180, 0, "E"),
        ).toThrow());
      test("(90, 0, S, 180, 0, 1, E)", () =>
        expect(() =>
          parseValues(sink(), 90, 0, "S", 180, 0, 1, "E"),
        ).toThrow());
    });
  });
  describe("8 DMS value parts", () => {
    ...
    describe("Invalid", () => {
      test("(0, 0, 0, E, 0, 0, 0, S)", () =>
        expect(() =>
          parseValues(sink(), 0, 0, 0, "E", 0, 0, 0, "S"),
        ).toThrow());
      test("(0, 0, 0, X, 0, 0, 0, X)", () =>
        expect(() =>
          parseValues(sink(), 0, 0, 0, "X", 0, 0, 0, "X"),
        ).toThrow());
      test("(90, 0, 1, S, 180, 0, 0, E)", () =>
        expect(() =>
          parseValues(sink(), 90, 0, 1, "S", 180, 0, 0, "E"),
        ).toThrow());
      test("(90, 1, 0, S, 180, 0, 0, E)", () =>
        expect(() =>
          parseValues(sink(), 90, 1, 0, "S", 180, 0, 0, "E"),
        ).toThrow());
      test("(91, 0, 0, S, 180, 0, 0, E)", () =>
        expect(() =>
          parseValues(sink(), 91, 0, 0, "S", 180, 0, 0, "E"),
        ).toThrow());
      test("(90, 0, 0, S, 180, 0, 1, E)", () =>
        expect(() =>
          parseValues(sink(), 90, 0, 0, "S", 180, 0, 1, "E"),
        ).toThrow());
      test("(90, 0, 0, S, 180, 1, 0, E)", () =>
        expect(() =>
          parseValues(sink(), 90, 0, 0, "S", 180, 1, 0, "E"),
        ).toThrow());
      test("(90, 0, 0, S, 181, 0, 0, E)", () =>
        expect(() =>
          parseValues(sink(), 90, 0, 0, "S", 181, 0, 0, "E"),
        ).toThrow());
    });
  });
  describe("Invalid DMS value parts", () => {
    test("Too many parts", () => {
      expect(() =>
        parseValues(sink(), 0, 0, 0, 0, "N", 0, 0, 0, 0, "E"),
      ).toThrow();
    });
    test("Too many parts in latitude", () => {
      expect(() =>
        parseValues(sink(), 0, 0, 0, 0, 0, "N", 0, "E"),
      ).toThrow();
    });
    test("Too many parts in longitude", () => {
      expect(() =>
        parseValues(sink(), 0, "N", 0, 0, 0, 0, 0, "E"),
      ).toThrow();
    });
    test("Excess values after coordinates", () => {
      expect(() => parseValues(sink(), 0, "N", 0, "E", 0, 0, 0)).toThrow();
    });
    test("Array within coordinates", () => {
      expect(() => parseValues(sink(), [0], "N", 0, "E")).toThrow();
    });
    test("5 numbers", () => {
      expect(() => parseValues(sink(), 0, 0, 0, 0, 0)).toThrow();
    });
  });
});
